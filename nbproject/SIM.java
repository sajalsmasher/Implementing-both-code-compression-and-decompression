...
String x="xxxx";
    public void ex_dictionary(String com) throws IOException, FileNotFoundException{
				...
				while (( str = buffread_brc.readLine())!= null){
                                    write1();
    ...
    public void dedata_comp() throws IOException, FileNotFoundException{
			try{
				...
				while (comp_Values_data.length()>3){
					...
					if (cd_c.equals("000") && ((ct_n +2) < comp_Values_data.length())){
					...
					else if(cd_c.equals("001") && ((ct_n +12) < comp_Values_data.length())){
						...
						ind = Integer.parseInt(mark_in,2);
                                                String str;
                                                str = dictionary_compress.get(ind);
                                                int i = 0;
                                                while (i < ms.length()){
                                                if (ms.charAt(i) == '1'){
                                                if (str.charAt(j1) == '0')
					...
					else if(cd_c.equals("010") && ((ct_n +8) < comp_Values_data.length())){
						loc1 = comp_Values_data.substring(0,5);
						comp_Values_data = comp_Values_data.substring(5);
						mark_in = comp_Values_data.substring(0,3);
						comp_Values_data = comp_Values_data.substring(3);
					...
					else if(cd_c.equals("011") && ((ct_n +8) < comp_Values_data.length())){
						loc1 = comp_Values_data.substring(0,5);
						comp_Values_data = comp_Values_data.substring(5);
						mark_in = comp_Values_data.substring(0,3);
						comp_Values_data = comp_Values_data.substring(3);
					...
					else if(cd_c.equals("100") && ((ct_n +13) < comp_Values_data.length())){
						loc1 = comp_Values_data.substring(0,5);
						comp_Values_data = comp_Values_data.substring(5);
					...
					else if(cd_c.equals("101") && ((ct_n +3) < comp_Values_data.length())){
						mark_in = comp_Values_data.substring(0, 3);
						comp_Values_data = comp_Values_data.substring(3);
						ind = Integer.parseInt(mark_in,2);
						rev_st = dictionary_compress.get(ind);
						
						buffwrite_bwd.write(rev_st);
						buffwrite_bwd.newLine();
					}
					else if(cd_c.equals("110") && ((ct_n +32) < comp_Values_data.length())){
